...
if __name__ == '__main__':
    ...
    song = AudioSegment.from_file(r"E:\pythonProject\dataset\123.flac")
    # song.export(r"E:\pythonProject\dataset", format="wav")
    # flac_to_wav(r"E:\pythonProject\dataset\LibriSpeech\dev-clean\84\121123\84-121123-0000.flac", r"E:\pythonProject\dataset\LibriSpeech_wav\val")