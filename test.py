...
def main(configs):
    ...
    wm_generator = WatermarkModel(encoder=encoder, decoder=decoder, model_config=model_config).to(device)
    wm_detector = WatermarkDetector(detector=detector, nbits=0, model_config=model_config).to(device)
